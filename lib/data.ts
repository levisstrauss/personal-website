...
export const personalInfo = {
  ...
  roles: ["AI/ML Engineer", "MLOps Engineer", "Open for Research"],
  location: "United States",
  email: "zcoulibalyeng@gmail.com",
  bio: "I'm a Machine Learning Engineer focused on bridging model development and production deployment. " +
      "Currently completing my M.S. in Computer Science (AI/ML) at UIUC. I'm the person who reads the source " +
      "code instead of just the documentation. I need to understand how things work under the hood. I don't just train " +
      "models. I deploy them.",
